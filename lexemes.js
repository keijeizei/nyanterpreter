...
var all_pl_elements = [
	...
	new PLElement("SAY", /^SAY$/g),
	new PLElement("SO", /^SO$/g),
...
var token_to_classification = {
	...
	"BIGGR_OF": "Max Operation Keyword",
	...
	"MEBBE": "Flow-Control Delimiter Keyword",
	...
	"PRODUKT_OF": "Multiplication Operation Keyword",
	"QUOSHUNT_OF": "Division Operation Keyword",
	"R": "Variable Assignment Keyword",
	"SMALLR_OF": "Min Operation Keyword",
	...
	"YARN": "YARN Literal",
    "YR": "Parameter Delimiter Keyword",
	"WIN": "WIN Literal",
